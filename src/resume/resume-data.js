...
export const data = {
  ...
  secondPage: [
    ...
    { type: 'Certification Education Degree', value: '1. MSCSE in Software Engineering from United International University (UIU).', isIcon: false, className: 'ms-4 common-font-size' },
    { type: 'Certification Education Degree', value: '2. PGDICT in ICT from Bangladesh Computer Council (BCC).', isIcon: false, className: 'ms-4 common-font-size' },
    { type: 'Certification Education Degree', value: '3. ESAD in C# .NET from IDB-BISEW.', isIcon: false, className: 'ms-4 common-font-size' },
    { type: 'Certification Education Degree', value: '4. MBA in Management from Dhaka University (DU).', isIcon: false, className: 'ms-4 common-font-size' },
    { type: 'Certification Education Degree', value: '5. MBS in Management from Dhaka College (DC).', isIcon: false, className: 'ms-4 common-font-size' },
    { type: 'Certification Education Degree', value: '6.  BBS in Management from Dhaka College (DC).', isIcon: false, className: 'ms-4 common-font-size' },
