...
function Home() {
    ...
    return (
        <div className='card technology rounded-0 border-0 mt-5'>
            <div className='main-card card-body d-flex flex-lg-row flex-column gap-4'>
                <div class="glass-card shadow-lg card w-25 w-100">
                    <h3 className='text-info m-0'>Back-End Technology</h3>
                    <hr />
                    <ul>
                ...
                <div class="glass-card shadow-lg card w-25 w-100">
                    <h3 className='text-info m-0'>Client-Side Technology</h3>
                    <hr />
                    <ul>
                ...
                <div class="glass-card shadow-lg card w-25 w-100" >
                    <h3 className='text-info m-0'>Data Base</h3>
                    <hr />
                    <ul>
                ...
                <div class="glass-card shadow-lg card w-25 w-100">
                    <h3 className='text-info m-0'>DevOps Things</h3>
                    <hr />
                    <ul>
                ...
                <div class="glass-card shadow-lg card w-25 w-100" >
                    <h3 className='text-info m-0'>Source Control</h3>
                    <hr />
                    <ul>
